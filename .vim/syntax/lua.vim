...
" other keywords
syn keyword luaInfo      Info
syn keyword luaWarning   Warning
syn keyword luaErr       Error Abort
...
syn keyword luaFunc print rawget rawset tonumber tostring type _VERSION check_error
...
elseif lua_version == 5
  ...
  syn match   luaFunc /tb\:exec/
  syn match   luaFunc /sb\:exec/
  syn match   luaFunc /cb\:exec/
  syn match   luaFunc /ts\:exec/
...
if version >= 508 || !exists("did_lua_syntax_inits")
  ...
  HiLink luaInfo		Directory
  HiLink luaWarning		Title
  HiLink luaErr		Operator
